  ...
  display = () => {
    if (this.state.currentArticle){
      return  (<div className="main-container">
                ...
                <MapsList currentArticle = {this.state.currentArticle} user={this.props.user} userMapView={this.state.userMapView} changeUserMapView={this.changeUserMapView} updateUserPlaces={this.updateUserPlaces}/>
              </div>)
    } else {
